...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, KPEventListener, SelectMediaFragment.MediaIdPostman {
    ...
    private static final String TAG = "KalturaChangeMediaDemp";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //SelectMediaDialogFragment myFragment = new SelectMediaDialogFragment();
    ...
    public void postMediaId(String mediaId) {
        ...
        if (mPlayer == null) {
            ...
            //KPPlayerConfig config = new KPPlayerConfig("http://kgit.html5video.org/tags/v2.42.rc8/mwEmbedFrame.php", "33189171", "2068231").setEntryId(currentMediaId);
    ...
    private PlayerViewController getPlayer() {
        if (mPlayer == null) {
            ...
            //http://kgit.html5video.org/tags/v2.42.rc4/mwEmbedFrame.php/p/243342/sp/24334200/embedIframeJs/uiconf_id/12905712/entry_id/0_uka1msg4?iframeembed=true&wid=_243342&uiconf_id=12905712&entry_id=0_uka1msg4&flashvars%5BEmbedPlayer.ShowPosterOnStop%5D=false
