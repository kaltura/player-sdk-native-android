...
public class SupportedFormat {
    ...
    public SupportedFormat(String mimeType, String pathExt) {
        this(mimeType, pathExt, null);
    }

    public static final SupportedFormat HLS_CLEAR = new SupportedFormat("application/vnd.apple.mpegurl", ".m3u8");
    public static final SupportedFormat MP4_CLEAR = new SupportedFormat("video/mp4", ".mp4");
    public static final SupportedFormat DASH_CLEAR = new SupportedFormat("application/dash+xml", ".mpd");
