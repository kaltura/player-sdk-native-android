 ...
 */
public class KIMAAdapter {

    // The wrapped video player.
    private KPlayerController.KPlayer mVideoPlayer;
    ...
    public KIMAAdapter(KPlayerController.KPlayer player, ViewGroup adUiContainer) {
        mVideoPlayer = player;
    ...
    public void init() {
        ...
        mVideoAdPlayer = new VideoAdPlayer() {
            ...
            public void loadAd(String url) {
                mIsAdDisplayed = true;
                mVideoPlayer.setPlayerSource(url);
            }
            ...
            public VideoProgressUpdate getAdProgress() {
                ...
                return new VideoProgressUpdate((long)mVideoPlayer.getCurrentPlaybackTime(),
                        (long)mVideoPlayer.getDuration());
            }
        };
        // [END init_region]
        ...
        mVideoPlayer.setPlayerCallback(new KPlayerCallback() {
            @Override
            public void onPlay() {
                if (mIsAdDisplayed) {
    ...
    public void savePosition() {
        mSavedContentVideoPosition = (int)mVideoPlayer.getCurrentPlaybackTime();
    }
    ...
    public void restorePosition() {
        mVideoPlayer.setCurrentPlaybackTime(mSavedContentVideoPosition);
    }
    ...
    public KPlayerController.KPlayer getVideoPlayer() {
        return mVideoPlayer;
    }
    ...
    public void resumeContentAfterAdPlayback() {
        ...
        mIsAdDisplayed = false;
        mVideoPlayer.setPlayerSource(mContentVideoUrl);
        restorePosition();
